			...
			<div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-12 mb-xl-12">
                ...
                <div class="card">
                    <div class="card-header pt-5">
                        <div class="">
                            <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">Store Edit</span>
                        </div>
                    ...
                    <div class="card-body pt-6">
                        <form action="{{route('admin.store.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" class="form-control" name="store_name" placeholder="Store Name" value="{{$stores->store_name}}" required>
                            <input type="hidden" class="form-control" name="store_id" placeholder="Store Name" value="{{$stores->id}}" required>
                            <label for="">Store URL</label>
                            <input type="text" class="form-control" name="store_url" placeholder="Store URL" value="{{$stores->store_slug}}" required>
                            ...
                            @if($stores->store_logo)
                                <img class="store-logo" src="{{asset('storage/logo/'.$stores->store_logo)}}">
                            @endif
