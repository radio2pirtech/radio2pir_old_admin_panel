...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('images/store_images/stores/gourmesserie_logo.jpeg')}}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form">
                            ...
                            <input type="hidden" name="from_name" value="Gourmesserie -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="http://live.radio2pir.com/gourmesserie">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="d-flex align-items-center main_logo_two_pie">
                    <!--<img src="{{asset('images/store_images/stores/gourmesserie_logo.jpeg')}}" height="100" alt="CoolBrand">-->
    ...
    <div class="container container-fluid">
        ...
        <div class="row my-5" id="description">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <img src="{{asset('images/store_images/stores/gourmesserie_logo.jpeg')}}" height="150" class="Description_image2" alt="CoolBrand">
            </div>
            <div class="col-md-6">
            ...
            <div class="row bg-bottom">
                <div class="container container-fluid">
                    <div class="col-md-12" style="text-transform: uppercase;">
                        <a href="#"><p class="text-center pt-2 mb-2">Gourmesserie - Radio 2 PI R </a> | Copyright © 2025</p>
                    </div>
                </div>
            </div>
        </div>
