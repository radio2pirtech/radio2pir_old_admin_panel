...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('images/store_images/stores/anytimefitness-favicon.ico')}}">
...
/* new css for show schedule */
.show_schedule_main .col-xs-12.col-sm-3 {
...
@keyframes border-glow {
  0% {
    border-color: #8deff6;
    box-shadow: 0 0 5px rgba(141, 239, 246, 0.5);
  }
  50% {
    border-color: #4bcad8;
    box-shadow: 0 0 15px rgba(75, 202, 216, 0.8);
  }
  100% {
    border-color: #8deff6;
    box-shadow: 0 0 5px rgba(141, 239, 246, 0.5);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form">
                            ...
                            <input type="hidden" name="from_name" value="anytimefitness -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="http://live.radio2pir.com/anytimefitness">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="d-flex align-items-center main_logo_two_pie">
                    ...
                    <img src="{{asset('images/store_images/stores/anytimefitness_logo.png')}}" height="100" alt="CoolBrand">
                </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('images/store_images/stores/anytimefitness-slider1.jpg')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('images/store_images/stores/anytimefitness-slider2.jpg')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
    ...
    <div class="container container-fluid">
        ...
        <div class="row my-5" id="Description">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <img src="{{asset('images/store_images/stores/2pir_logo.png')}}" height="150" class="Description_image2" alt="CoolBrand">
            </div>
            <div class="col-md-6">
        ...
        <div id="Radio" class="wrapper-grey padded show_schedule_main">
            <div class="container">
                <h2 class="template_main_heading">Personalized Radio for Anytime Fitness</h2>
                <div class="big_border_headline "></div>
                <div class="small_border_headline"></div>
                 
                <div class="row justify-content-center">
                <div class="text-center">
                        <div class="card2 crd mx-auto" style="background: url('{{asset('images/store_images/stores/anytimefitness-card.jpg')}}');
                        background-size: 262px 450px; background-position: center; background-repeat: no-repeat;">
                          <div class="play_pause_btn card-user avatar avatar-large" id="btn_play_pause_card">
                                <i class="fa fa-play" id="ic_btn_play_pause_card" style="font-size: 30px;"></i>
                            </div>
                        </div>
                        <h4 class="text-center" style="margin-top: 50px;">Anytime Fitness Second Channel</h4>
                    </div>
                    </div>
            </div>
        </div>
            ...
            <div class="row bg-bottom">
                <div class="container container-fluid">
                    <div class="col-md-12" style="text-transform: uppercase;">
                        <a href="#"><p class="text-center pt-2 mb-2">anytimefitness - Radio 2 PI R </a> | Copyright © 2025</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- javascript started -->
    ...
    <!-- 2nd play button js starts -->
    <script>
    $(document).ready(function() {
        var audioPlayer = document.getElementById("myAudio");
        var cardAudioPlayer = document.createElement("audio");
        cardAudioPlayer.id = "cardAudio";
        document.body.appendChild(cardAudioPlayer);
        
        // update second radio url here:-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        var cardRadioUrl = "{{ $page->radio_url ?? 'https://play.radioking.io/anytimefitnesscha2' }}";  
        var cardPlayState = false;
        var currentPlayingRadio = null;
    
        $("#btn_play_pause_card").click(function() {
            console.log("Card play button clicked");
            handleCardBtnClick();
        });
    
        function handleCardBtnClick() {
            if (cardPlayState === true) {
                // Stop card radio
                ...
                // Update UI
                $("#ic_btn_play_pause_card").attr('class', 'fa fa-play');
            } else {
                // Stop all other audio using the existing function
                stopOtherAudio(cardAudioPlayer);
                
                // If main radio is playing, stop it
                if (typeof playState !== 'undefined' && playState === true) {
                    audioPlayer.pause();
                    audioPlayer.src = "";
                    playState = false;
                    $("#ic_btn_play_pause").attr('class', 'fa fa-play');
                ...
                // Start card radio
                cardAudioPlayer.src = cardRadioUrl;
                cardAudioPlayer.play();
                cardPlayState = true;
                currentPlayingRadio = "card";
                
                // Update UI
                $("#ic_btn_play_pause_card").attr('class', 'fa fa-pause');
            }
        }
    
        // Add card audio player to the existing audio control system
        cardAudioPlayer.addEventListener('play', function() {
            // Stop other audio players using existing function
            stopOtherAudio(cardAudioPlayer);
        ...
        // Listen for when other audio starts playing to stop card audio
        ...
        // Listen for main audio play event to stop card audio
        if (audioPlayer) {
        ...
        // Handle audio errors
        cardAudioPlayer.addEventListener('error', function() {
            console.error("Error playing card radio");
            cardPlayState = false;
            $("#ic_btn_play_pause_card").attr('class', 'fa fa-play');
        });
    
        // Handle audio ended
        cardAudioPlayer.addEventListener('ended', function() {
            cardPlayState = false;
            $("#ic_btn_play_pause_card").attr('class', 'fa fa-play');
        });
    
        // Add card audio to close button functionality
        var closeButtons = document.querySelectorAll(".close");
        closeButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                if (cardPlayState === true) {
