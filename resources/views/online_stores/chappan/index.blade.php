            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form">
                            ...
                            <input type="hidden" name="from_name" value="Chappan -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="http://live.radio2pir.com/chappan">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form4">
                            ...
                            <input type="hidden" name="from_name" value="Chappan -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="https://live.radio2pir.com/chappan">
            ...
            <div class="row bg-bottom">
                <div class="container container-fluid">
                    <div class="col-md-12" style="text-transform: uppercase;">
                        <a href="#"><p class="text-center pt-2 mb-2">Chappan - Radio 2 PI R </a> | Copyright © 2025</p>
                    </div>
                </div>
            </div>
        </div>
