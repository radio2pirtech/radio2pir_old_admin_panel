...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('images/store_images/stores/snops_logo.png')}}">
...
.navbar_div_main span {
  background-image: url(../images/headphone_nav.png);
  width: 15px;
  height: 15px;
  display: block;
...
.location1 {
  padding-left: 30px;
  background: url('{{asset('public/images/store_images/stores/icon-location.png')}}') 0 5px no-repeat;
  color: #fff;
  margin-bottom: 10px;
}
...
.phone1 {
  padding-left: 30px;
  background: url('{{asset('public/images/store_images/stores/icon-phone.png')}}') 0 5px no-repeat;
  color: #fff;
  margin-bottom: 10px;
}
...
.mail1 {
  padding-left: 30px;
  background: url('{{asset('public/images/store_images/stores/icon-mail.png')}}') 0 5px no-repeat;
  color: #fff;
  margin-bottom: 10px;
}
  </style>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form">
                            ...
                            <input type="hidden" name="from_name" value="Snops -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="http://live.radio2pir.com/snops">
    ...
    <div class="container container-fluid">
        ...
        <div class="play_pause_main">
            <div class="play_pause_main_inner" id="btn_play_pause">
                <img src="{{asset('public/images/store_images/stores/2pir_logo.png')}}" class="play_pause_main_inner_img" height="60px">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item main_carousel_outer active">
                <img src="{{asset('public/images/store_images/stores/radio_image7.webp')}}" alt="" style="width:100%; height: 450px;">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('public/images/store_images/stores/snops_footware-1.webp')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('public/images/store_images/stores/snops_Woman-Fashion.webp')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('public/images/store_images/stores/snops_White-Modern-Fashion-Men-Banner-1-scaled.webp')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
    ...
    <div class="container container-fluid">
        ...
        <div class="row my-5" id="description">
            <div class="col-md-6 d-flex align-items-center">
                <img src="{{asset('public/images/store_images/stores/radio_image2.webp')}}" class="Description_image1" height="300" alt="CoolBrand">
                <img src="{{asset('public/images/store_images/stores/2pir_logo.png')}}" height="150" class="Description_image2" alt="CoolBrand">
            </div>
            <div class="col-md-6">
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content"> 
                    ...
                    <div class="modal-body">
                        <img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/affair_with_air.jpeg')}}" style="height: 200px; width: 200px; border-radius: 10px; margin: 10px;">        
                        
                        <audio class="audio" controls><source src="{{asset('public/audio/radio_element_affairwithair.mpeg')}}" type="audio/mp3"></audio>
        ...
        <div class="modal fade" id="exampleModal2a" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content"> 
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel" style="text-transform: uppercase;">employee celebration</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/khat_dil_se_dil_tak.jpeg')}}" style="height: 200px; width: 200px; border-radius: 10px; margin: 10px;">        
                        
                        <audio class="audio" controls><source src="{{asset('public/audio/radio_element_employeecelebration.mp3')}}" type="audio/mp3"></audio>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form2">
                            ...
                            <input type="hidden" name="access_key" value="a561802e-54fa-4124-a226-e107abaacb70" />
                            <input type="hidden" name="subject" value="New employee celebration form Submission">
                            <input type="hidden" name="from_name" value="Snops -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="http://live.radio2pir.com/snops">
                            <input type="checkbox" name="botcheck" class="hidden" style="display: none;">
        ...
        <div class="modal fade" id="exampleModal2b" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content"> 
                    ...
                    <div class="modal-body">
                        <img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/fun_with_tadka.jpeg')}}" style="height: 200px; width: 200px; border-radius: 10px; margin: 10px;">        
                        
                        <audio class="audio" controls><source src="{{asset('public/audio/radio_element_funwithtadka.mpeg')}}" type="audio/mp3"></audio>
       ...
       <!-- get_popular -->
        <div class="modal fade" id="exampleModal2c" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content"> 
                    ...
                    <div class="modal-body">
                        <img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/get_popular.jpeg')}}" style="height: 200px; width: 200px; border-radius: 10px; margin: 10px;">        
                        
                        <audio class="audio" controls><source src="{{asset('public/audio/radio_element_getpopular.mpeg')}}" type="audio/mp3"></audio>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-3">
                        <div class="card2 crd" style="background: url('{{asset('public/images/store_images/stores/affair_with_air.jpeg')}}');
                        background-size: 262px 450px; background-position: center; background-repeat: no-repeat;">
                           <a href="#" class="nav-item nav-link" data-toggle="modal" 
                            data-target="#exampleModal2"><img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/playbtn.png')}}">
                        </a>
                        </div>
                        <h5 class="text-center mt-5" >Affair with air</h5>
                    </div>
                    <div class="col-xs-12 col-sm-3">
                        <div class="card2 crd" style="background: url('{{asset('public/images/store_images/stores/khat_dil_se_dil_tak.jpeg')}}');
                        background-size: 262px 450px; background-position: center; background-repeat: no-repeat;">
                            <a href="#" class="nav-item nav-link" data-toggle="modal" 
                            data-target="#exampleModal2a"><img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/playbtn.png')}}">
                        </a>
                        </div>
                        <h5 class="text-center mt-5">employee celebration</h5>
                    </div>
                    <div class="col-xs-12 col-sm-3">
                        <div class="card2 crd" style="background: url('{{asset('public/images/store_images/stores/fun_with_tadka.jpeg')}}');
                        background-size: 262px 450px; background-position: center; background-repeat: no-repeat;">
                            <a href="#" class="nav-item nav-link" data-toggle="modal" 
                            data-target="#exampleModal2b"><img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/playbtn.png')}}">
                        </a>
                        </div>
                        <h5 class="text-center mt-5">Fun with tadka</h5>
                    </div>
                    <div class="col-xs-12 col-sm-3">
                        <div class="card2 crd" style="background: url('{{asset('public/images/store_images/stores/get_popular.jpeg')}}');
                        background-size: 262px 450px; background-position: center; background-repeat: no-repeat;">
                            <a href="#" class="nav-item nav-link" data-toggle="modal" 
                            data-target="#exampleModal2c"><img class="card-user avatar avatar-large" src="{{asset('public/images/store_images/stores/playbtn.png')}}">
                        </a>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                    <div class="gallery_img_outer_div1 text-center">
                        <img src="{{asset('public/images/store_images/stores/advertisingpartner.jpeg')}}" class="w-100 shadow-1-strong rounded mb-4" alt="" /></div>
                    </div>
            </div>
        </div>
        <!-- clientele end -->
        ...
        <div id="team">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3">
                    <div class="card" style="border: unset; "><img src="{{asset('public/images/store_images/stores/Janvi_Barot.JPG')}}" alt="" 
                ...
                <div class="col-xs-12 col-sm-3">
                    <div class="card" style="border: unset; "><img src="{{asset('public/images/store_images/stores/jr-rj-palak.jpeg')}}" alt="" 
                        style="border-radius: 8px; height: 220px;">
                        <div class="card-body main_card_img_main">
                            <h3>Palak Raiya</h3>
                            <p class="card-text">Radio Jockey</p>
                ...
                <div class="col-xs-12 col-sm-3">
                    <div class="card" style="border: unset; "><img src="{{asset('public/images/store_images/stores/Rajiv_Arya.jpeg')}}" alt="" 
                        style="border-radius: 8px; height: 220px;">
                        <div class="card-body main_card_img_main">
                            <h3>Rajiv Arya</h3>
                            <p class="card-text">Radio Jockey</p>
                ...
                <div class="col-xs-12 col-sm-3">
                    <div class="card" style="border: unset; "><img src="{{asset('public/images/store_images/stores/jr-rj-heer.jpeg')}}" alt="" 
                        style="border-radius: 8px; height: 220px;">
                        <div class="card-body main_card_img_main">
                            <h3>Heer Dhakan</h3>
                            <p class="card-text">Radio Jockey</p>
                    ...
                    <div class="col-md-12 p-5">
                        <div class="row">
                            <div class="col-md-3">
                                <h3>reach out us</h3>
                                <p class="pt-1"> </p>
                                <div class="location1"><p class="address">B/5, Anand Mangal1 Nr,Swastik Char Rasta, Chimanlal Girdharlal Rd, Navrangpura, Ahmedabad, Gujarat 380009</p></div>
            ...
            <div class="row bg-bottom">
                <div class="container container-fluid">
                    <div class="col-md-12" style="text-transform: uppercase;">
                        <a href="#"><p class="text-center pt-2 mb-2">Snops - Radio 2 PI R </a> | Copyright © 2025</p>
                    </div>
                </div>
            </div>
        </div>
