...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('images/store_images/stores/teapost_logo.png')}}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form">
                            ...
                            <input type="hidden" name="redirect" value="http://live.radio2pir.com/teapost">
    ...
    <div class="container container-fluid">
        ...
        <div class="row my-5" id="description">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <img src="{{asset('images/store_images/stores/teapost_logo.png')}}" height="150" class="Description_image2" alt="CoolBrand">
            </div>
            <div class="col-md-6">
            ...
            <div class="row bg-bottom">
                <div class="container container-fluid">
                    <div class="col-md-12" style="text-transform: uppercase;">
                        <a href="#"><p class="text-center pt-2 mb-2">Tea Post - Radio 2 PI R </a> | Copyright © 2025</p>
                    </div>
                </div>
            </div>
        </div>
