...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('images/store_images/stores/delhibuses_logo1.png')}}">
...
/* Styles for Radio Elements section start */
.wrapper-grey.padded.show_schedule_main .container {
  max-width: 1500px;
  margin: 0 auto;
  padding: 0 15px;
}

.wrapper-grey.padded.show_schedule_main .row {
  display: flex;
  flex-wrap: wrap;
...
.wrapper-grey.padded.show_schedule_main .col-xs-12.col-sm-3 {
  flex: 0 0 20%;
  padding: 0 10px;
  max-width: 20%;
}
...
@media (max-width: 576px) {
  ...
  .wrapper-grey.padded.show_schedule_main {
    padding: 40px 0;
  }
...
/* Styles for Radio Elements section end */
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form">
                            ...
                            <input type="hidden" name="from_name" value="Delhi Buses -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="https://live.radio2pir.com/delhibuses">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="d-flex align-items-center main_logo_two_pie">
                    ...
                    <img src="{{asset('images/store_images/stores/delhibuses_logo1.png')}}" height="100" alt="CoolBrand">
                </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('images/store_images/stores/delhibuses_slider1.webp')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('images/store_images/stores/delhibuses_slider2.jpg')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="item main_carousel_outer">
                <img src="{{asset('images/store_images/stores/delhibuses_slider3.avif')}}" alt="" style="width:100%; height: 450px;">
                <div class="carousel-caption">
                    <h3>Radio 2 PI R</h3>
                    <p>Listen with the ears & understand with the heart</p>
                    <button data-toggle="modal" data-target="#exampleModal">
    ...
    <div class="container container-fluid">
        ...
        <div class="row my-5" id="Description">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <img src="{{asset('images/store_images/stores/delhibuses_logo1.png')}}" height="150" class="Description_image2" alt="CoolBrand">
            </div>
            <div class="col-md-6">
       ...
       <!-- get_popular -->
        ...
        <!--song on demand-->
        <div class="modal fade" id="exampleModal2d" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content"> 
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel" style="text-transform: uppercase;">Song On Demand</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <img class="card-user avatar avatar-large" src="{{asset('images/store_images/stores/song_on_demand.jpeg')}}" style="height: 200px; width: 200px; border-radius: 10px; margin: 10px;">        
                        
                        <audio class="audio" controls><source src="{{asset('audio/radio_element_songondemand.mpeg')}}" type="audio/mp3"></audio>
                        
                        <div class="contact-form1"> 
                            <button data-toggle="modal" data-target="#exampleModal3e">To Avail</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="exampleModal3e" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Contact Us!</h5>
                    ...
                    <div class="modal-body">
                        <form action="https://api.web3forms.com/submit" method="POST" id="form4">
                            ...
                            <input type="hidden" name="access_key" value="a561802e-54fa-4124-a226-e107abaacb70" />
                            <input type="hidden" name="subject" value="New song on demand form Submission">
                            <input type="hidden" name="from_name" value="Delhi Buses -Radio 2 PIR">
                            <input type="hidden" name="redirect" value="https://live.radio2pir.com/delhibuses">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-3">
                        <div class="card2 crd" style="background: url('{{asset('images/store_images/stores/song_on_demand.jpeg')}}');
                        background-size: 262px 450px; background-position: center; background-repeat: no-repeat;">
                           <a href="#" class="nav-item nav-link" data-toggle="modal" 
                            data-target="#exampleModal2d"><img class="card-user avatar avatar-large" src="{{asset('images/store_images/stores/playbtn.png')}}">
                        </a>
                        </div>
                        <h5 class="text-center mt-5" >Song On Demand</h5>
                    </div>
                    <div class="col-xs-12 col-sm-3">
        ...
        <div id="Shows">
            ...
            <div class="row">
                    <div class="col-xs-12 col-sm-3">
                    <div class="card" style="border: unset; "><img src="{{asset('images/store_images/stores/Rj-nita1.jpeg')}}" alt="" 
                        style="border-radius: 8px; height: 220px;">
                        <div class="card-body main_card_img_main">
                        <h3>08:00 - 09:00 AM</h3>
                        <h3>Bhaktiras</h3>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-3">
                    <div class="card" style="border: unset; "><img src="{{asset('images/store_images/stores/Rj-shivam.jpeg')}}" alt="" 
                        style="border-radius: 8px; height: 220px;">
                        <div class="card-body main_card_img_main">
                        <h3>12:00 - 4:00 PM</h3>
                        <h3>Dil se Delhi</h3>
                ...
                <div class="col-xs-12 col-sm-3">
                    <div class="card" style="border: unset; "><img src="{{asset('images/store_images/stores/Rj-shruti.jpg')}}" alt="" 
                        style="border-radius: 8px; height: 220px;">
                        <div class="card-body main_card_img_main">
                        <h3>4:00 - 8:00 PM</h3>
                        <h3>Sham Shandaar</h3>
        ...
        <!--media start -->
        <div class="our_gallery_radio1" id="Media">
            <h2 class="template_main_heading">Radio 2 PI R In Media</h2>
            <div class="big_border_headline "></div>
            <div class="small_border_headline"></div>
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12 mb-4 mb-lg-0">
                    <div class="gallery_img_outer_div1 text-center">
                        <img src="{{asset('images/store_images/stores/delhibuses_media.jpeg')}}" class="w-100 shadow-1-strong rounded mb-4" alt=""/></div>
                    </div>
            </div>
        </div>
        <!--media end -->
            ...
            <div class="row bg-bottom">
                <div class="container container-fluid">
                    <div class="col-md-12" style="text-transform: uppercase;">
                        <a href="#"><p class="text-center pt-2 mb-2">Delhi Buses - Radio 2 PI R </a> | Copyright © 2025</p>
                    </div>
                </div>
            </div>
        </div>
